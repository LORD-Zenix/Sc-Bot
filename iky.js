...
const isImage = (type === 'imageMessage')
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
      ...
      const daftar1 = `Hai kak  ${pushname} ${ucapanWaktu} \n\nSebelum Menggunakan 𝙆𝙄𝙍𝙄𝙂𝙄𝙍𝙄𝘽𝙊𝙏Verify Terlebih Dahulu Ya `
      ...
      // GAME 
        ...
        if (game.isfam(from, family100)) {
          ...
          if (tebakata.hasOwnProperty(sender.split('@')[0]) && !isCmd) {
			...
			tc = `MAAF KA NOMER KAMU BLOM TERDAFTAR DI DATABASE SILAHKAN KETIK !verify UNTUK MENDAFTAR DI 𝙆𝙄𝙍𝙄𝙂𝙄𝙍𝙄𝘽𝙊𝙏`
			ind = {
...
`
                    ...
                    ikyy.sendMessage(from, { contentText: `${menu}`, footerText: 'ADYY4YOU BOTZ', buttons: [{ buttonId: `!command`, buttonText: { displayText: '📙MENU' }, type: 1 },{ buttonId: `!sewabot`, buttonText: { displayText: '🏷️ SEWA BOT' }, type: 1 },{ buttonId: `!owner`, buttonText: { displayText: '👥 OWNER' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: ikyads, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
case 'f':
case 'lock':
 ikymemek = {
...
🔖 ${prefix}wallgravity text1 text2
 `
sendButMessage(from, wibu, `created X 𝘽𝙊𝙏`, [
          {
            buttonId: `!menu`,
            buttonText: {
...
`
                   sendButMessage(from, wibu, `*ZENIX 𝙂𝘼𝙉𝙏𝙀𝙉𝙂*`, [
          {
            buttonId: `!menu`,
            buttonText: {
              displayText: `⬡ BACK TO MENU `,
...
`
        ...
        case 'simi':
				...
				buttons = [{buttonId: `!infoig`,buttonText:{displayText: ` Jangan Lupa Follow @tn.zenix`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'X 𝘽𝙊𝙏', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @tn.zenix`,buttons,headerType:4}
...
`
        ...
        case 'wasted':
		      ...
		      buttons = [{buttonId: `!infoig`,buttonText:{displayText: ` Jangan Lupa Follow @tn.zenix`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'ZENIX', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @tn.zenix`,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              ikyy.relayWAMessage(prep)
break
...
anu = await fetchJson(`https://leyscoders-api.herokuapp.com/api/ppcouple?apikey=IkyOgiwara`)
						...
						buttons = [{buttonId: `!infoig`,buttonText:{displayText: `Jangan Lupa Follow @𝙆𝙄𝙍𝙄𝙂𝙄𝙍𝙄𝘽𝙊𝙏`},type:1}]
              ...
              ikyy.relayWAMessage(prep)
                ...
                reply (mess.wait)
                 ...
                 buff = await getBuffer(`https://api.lolhuman.xyz/api/textprome2/${command}?apikey=IkyAds&text1=${txt1}&text2=${txt2}`)
                          buttons = [{buttonId: `!menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'𝙆𝙄𝙍𝙄𝙂𝙄𝙍𝙄𝘽𝙊𝙏', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @𝙆𝙄𝙍𝙄𝙂𝙄𝙍𝙄𝘽𝙊𝙏`,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              ikyy.relayWAMessage(prep)
...
`
 ...
 ADYY4YOU☕︎`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 1
}
...
`
 ...
 𝙆𝙄𝙍𝙄𝙂𝙄𝙍𝙄𝘽𝙊𝙏☕︎`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
*「 DYY4YOU BOTZ 」*`
	    ...
	    // console.log(e)
            setTimeout( () => {
			ikyy.updatePresence(from, Presence.composing)
			reply(`*Terimakasih Telah Terdaftar Di DYY4YOU BOTZ*`)
		}, 2000)
        break
case 'sfire':
{
...
`
  buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: `OWNER`},type:1},{buttonId: `${prefix}payment`,buttonText:{displayText: `PAYMENT`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'ADYY4YOU', imageMessage: imageMsg,
...
//------------------< Owner >-------------------
      ...
      case 'broadcast':
             ...
             for (let _ of anu) {
             ikyy.sendMessage(_.jid, bc, image, {quoted:freply,caption: `*「 X 𝘽𝙊𝙏 NEWS 」*\n\n${body.slice(4)}`})
}
             reply('Suksess broadcast')
             } else {
             for (let _ of anu) {
             sendMess(_.jid, `*「 X 𝘽𝙊𝙏 NEWS 」*\n\n${body.slice(4)}`)
}
             reply('Suksess broadcast')
}
             break
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport':
              ...
              ikyy.sendMessage('6285701863281@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
...
//------------------< Menunya Bang:v >-------------------
      case 'infoig':
             reply(`Jangan Lupa Follow Ig Owner Ya : https://www.instagram.com/tn.zenix/`)
             break
      case 'ikyygroup':
             reply('https://chat.whatsapp.com/KFpYxFHvlCNKbTh1GkQnh9\nJangan Lupa Join Ya Kak ${pushname}')
             break
